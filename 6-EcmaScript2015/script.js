...
//isFullAge5(1990, 2000, 1966);
//isFullAge5(1990, 2000, 1966, 2017, 1985);
...
isFullAge6(1990, 2000, 1966, 2017, 1985);
*/
...
isFullAge6(16, 1990, 2000, 1966, 2017, 1985);
*/
...
var emily = new SmithPerson('Emily', 1989, 'Diaz', 'spanish')
...
question.set('question', 'What is the official name og the lateste major JavaScript version?');
question.set(1, 'ES5');
question.set(2, 'ES6');
...
class Street extends Element {
    constructor(name, buldYear, lenght, size = 3) {
        super(name, buldYear);
        this.length = lenght;
        this.size = size;
    }
    ...
    classifyStreet() {
        ...
        console.log(`${this.name}, build in ${this.buildYear}, is a ${classification.get(this.size)} steet.`);
    }
}

const allParks = [new Park('Green Park', 1980, 0.2, 215),
...
function reportStreets(s) {
    ...
    const [totalLenght, avgLenght] = calc(s.map(el => el.length));
    console.log(`Our ${s.length} streets have a total lenght of ${totalLenght}km, with an average of ${avgLenght}km.`);
